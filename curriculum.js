...
export const PRINCIPLES = [
  /* ─────────────── Phase 0 · The Language of Business ───────────────
     Vocabulary first. You cannot reason about a P&L while you are still
     translating it. These come before everything else in the deck. */
  {
    ...
    cards: [
      ['What is a balance sheet, in one line?', 'What the business owns and owes at a single moment.'],
      ['Assets', 'What the business owns or is owed.'],
      ['Liabilities', 'What the business owes to someone else.'],
      ["Shareholders' equity", "What is left for the owners: assets minus liabilities."],
      ['Current assets', 'Cash, or anything expected to become cash within a year.'],
      ['Non-current (fixed) assets', 'Things kept longer than a year — buildings, equipment, patents.'],
      ['Accounts receivable (AR)', 'Money customers owe you for work already done.'],
      ['Accounts payable (AP)', 'Money you owe suppliers for things already received.'],
      ['Inventory', 'Goods bought or made and not yet sold.'],
      ['Goodwill', 'The premium paid over fair value when buying a company. It sits on the balance sheet until it is written down.'],
      ['Accrued liabilities', 'Costs already incurred but not yet paid — wages, interest, taxes.'],
      ['Deferred revenue', 'Cash taken for work not yet delivered. It is a liability, not income.'],
      ['Retained earnings', 'Profit kept in the business rather than paid out.'],
      ['Working capital', 'Current assets minus current liabilities.'],
      ['Book value', 'What the balance sheet says the business is worth: assets minus liabilities.'],
      ['Depreciation vs amortisation', 'Depreciation spreads the cost of physical things; amortisation does the same for intangible ones.'],
      ['Why does a balance sheet always balance?', 'Every entry is recorded twice — assets = liabilities + equity by construction.'],
    ],
  },
  {
    ...
    cards: [
      ['Income statement (P&L)', 'What the business earned and spent over a period, ending in profit or loss.'],
      ['Revenue (top line)', 'Everything billed for goods or services before any cost.'],
      ['COGS', 'Cost of goods sold — the direct cost of delivering what you sold.'],
      ['Gross profit', 'Revenue minus COGS.'],
      ['SG&A', 'Selling, general and administrative — the overhead of running the business.'],
      ['R&D', 'Research and development — spend on building what you sell next.'],
      ...
      ['One-time (non-recurring) item', 'A gain or cost that will not repeat. Strip it out before judging the run rate.'],
      ['Top line vs bottom line', 'Top line is revenue; bottom line is net income.'],
      ['Why EBITDA is popular and suspect', 'It compares operations across firms, but ignores the real cost of debt and equipment.'],
    ],
  },
  {
    ...
    cards: [
      ...
      ['The three sections of a cash flow statement', 'Operating, investing, financing.'],
      ['Cash flow from operations (CFO)', 'Cash generated by the core business.'],
      ['Cash flow from investing (CFI)', 'Cash spent on or received from long-term assets.'],
      ['Cash flow from financing (CFF)', 'Cash from raising or repaying capital, and paying dividends.'],
      ...
      ['Why net income and operating cash flow differ', 'Non-cash charges like depreciation, and timing — receivables, payables, inventory.'],
      ['Liquidity', 'How easily something turns into cash without losing value.'],
  ...
  },
  {
    ...
    cards: [
      ['GAAP', 'Generally Accepted Accounting Principles — the US rulebook for financial reporting.'],
      ['IFRS', 'International Financial Reporting Standards — the rulebook most of the rest of the world uses.'],
      ['Double-entry bookkeeping', 'Every transaction is recorded twice — where value came from and where it went.'],
      ['Debit and credit, plainly', 'Two sides of the same entry. Debits raise assets and expenses; credits raise liabilities, equity and income.'],
      ['Accrual accounting', 'Record revenue when earned and costs when incurred, regardless of when cash moves.'],
      ['Cash accounting', 'Record only when money actually moves.'],
      ['The matching principle', 'Put a cost in the same period as the revenue it helped produce.'],
      ['Revenue recognition', 'Revenue counts when the work is delivered, not when the cash lands.'],
      ['Conservatism', 'When in doubt, book losses early and gains late.'],
      ['Going concern', 'The accounts assume the business will still exist next year.'],
      ['Materiality', 'If an error is too small to change anyone\'s decision, it can be ignored.'],
      ['Fiscal year', 'A company\'s own 12-month reporting cycle. It need not match the calendar.'],
      ['Q1 through Q4', 'The four quarters of the fiscal year.'],
      ['YoY', 'Year over year — this period against the same period last year.'],
      ['QoQ', 'Quarter over quarter — this quarter against the last one.'],
  ...
  {
    id: 'business-acronyms', phase: 'p0', title: 'The acronyms you will hear weekly', builds: ['accounting-principles'],
    idea: 'None of them are hard. Not knowing them is what slows the room down.',
    cards: [
      ['ROI', 'Return on investment — gain ÷ amount invested.'],
      ['ROE', 'Return on equity — net income ÷ shareholders\' equity.'],
      ['ROA', 'Return on assets — net income ÷ total assets.'],
      ['ROIC', 'Return on invested capital — profit against all the capital in the business.'],
      ['P/E ratio', 'Price ÷ earnings per share. What the market pays for a dollar of profit.'],
      ['KPI', 'Key performance indicator — the few numbers you actually manage by.'],
      ['ARR / MRR', 'Annual and monthly recurring revenue.'],
      ['CAC', 'Customer acquisition cost.'],
      ['LTV (CLV)', 'Lifetime value of a customer, in gross margin.'],
      ['AOV', 'Average order value.'],
      ['NPS', 'Net promoter score — a loyalty measure from "would you recommend us?".'],
      ['TAM / SAM / SOM', 'Total addressable market, the slice you can serve, and the slice you can realistically win.'],
      ['B2B / B2C', 'Selling to businesses, or to consumers.'],
      ['SaaS', 'Software as a service — software sold as a subscription.'],
      ['MVP', 'Minimum viable product — the smallest build that tests the idea.'],
      ['P&L', 'Profit and loss statement — another name for the income statement.'],
      ['FY / CY', 'Fiscal year and calendar year.'],
      ['CAGR', 'Compound annual growth rate — the smoothed yearly rate between two points.'],
      ['NPV', 'Net present value — future cash flows discounted to today, minus the cost.'],
  ...
  },
  {
    ...
    cards: [
      ['LLC', 'Limited liability company — owners are not personally liable for company debts.'],
      ['C-corp', 'A company taxed separately from its owners. The standard for taking outside investment.'],
      ['S-corp', 'A US company whose profits pass to owners\' personal returns, avoiding double taxation.'],
      ['Sole proprietorship', 'One person, no legal separation — the owner carries the liability.'],
      ['Partnership', 'Two or more owners sharing profits and, usually, liability.'],
      ['Limited liability, plainly', 'The most you can lose is what you put in.'],
      ['Equity', 'Ownership. A share of what is left after debts.'],
      ['Common vs preferred stock', 'Preferred gets paid first and carries special rights; common is what founders and employees hold.'],
      ...
      ['CEO / CFO / COO', 'Chief executive (direction), chief financial (money), chief operating (execution).'],
      ...
      ['Fiduciary duty', 'A legal obligation to act in someone else\'s interest before your own.'],
      ['Due diligence', 'Verifying the claims before you commit.'],
      ['Term sheet', 'A non-binding summary of the deal before the contracts are drawn.'],
    ],
  },
